...
float gain2 = 0.5; // case 4
float gainp1 = 5000; // case 5
float gainp2 = 300; // case 5

float epsilon = 1; // for |angle|<0.1 in theory gain >= 10*epsilon (working in case 3, for case 4 use gain >=0.5*epsilon)
float beta0 = .001; // >0
...
float minm = 0.099; // min mass
float maxm = 0.101; // max mass
...
float minkf = 0.49; // min friction
float maxkf = 0.51; // max friction

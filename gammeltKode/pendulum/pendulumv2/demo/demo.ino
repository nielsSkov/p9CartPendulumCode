...
float gain2 =  3;// case 4
float gainp1 = 5000; // case 5
float gainp2 = 300; // case 5

float epsilon =  3;// for |angle|<0.1 in theory gain >= 10*epsilon 
float beta0 = 0; // >0
...
//    rho = 1/minG*(abs(maxb)*abs(velPend1)+abs(maxd)+abs(a*(1-maxG/nG))*abs(posPend1)+abs((1-maxG/nG)*gain2)*abs(velPend1));
